            ...
            while (true)
            {
                ...
                switch (option)
                {
                    ...
                    case 20:
                        ...
                        break;
                    case 21:
                        AddressBookSystem.UpdateDetails();
                        break;
                    case 22:
                        AddressBookSystem.GetDetailsInPeroid();
                        break;
                    case 23:
                        int result = AddressBookSystem.CountOfContactDetailsByCity();
                        Console.WriteLine("Count of Record by City is " + result);
                        break;
                    case 24:
